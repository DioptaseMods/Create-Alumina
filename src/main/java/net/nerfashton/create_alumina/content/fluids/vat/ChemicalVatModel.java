...
public class ChemicalVatModel extends CTModel {
    ...
    public static ChemicalVatModel standard(BakedModel originalModel) {
        return new ChemicalVatModel(originalModel, CAPartialModels.CHEMICAL_VAT, CAPartialModels.CHEMICAL_VAT_TOP, CAPartialModels.CHEMICAL_VAT_INNER);
    }

    private ChemicalVatModel(BakedModel originalModel, CTSpriteShiftEntry side, CTSpriteShiftEntry top, CTSpriteShiftEntry inner) {
